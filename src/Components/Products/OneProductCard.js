        ...
        <div className="card">
            <div className="card__content">
                <div className="card__front">
                        ...
                        <h5 className="card__name">{props.singleProduct.name}</h5>
                        <p className="card__category">{props.singleProduct.category}</p>
                        <p className="card__price" style={{ margin: "0.2rem" }}>€ {props.singleProduct.price}</p>
